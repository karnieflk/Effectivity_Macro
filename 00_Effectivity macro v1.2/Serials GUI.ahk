...
Gui, 7:Show, x%amonx% y%amony% w525 h300, About -- Effectivity Macro V%Version_Number%
Gui, 7: +AlwaysOnTop
return
...
Gui, 8:show, x%amonx% y%amony% w400 h75 
gui 8: +alwaysontop
Pausescript()
return
}
...
Gui 1:Show,  x%amonx% y%amony% , Effectivity Macro V%Version_Number%
gui 1: +alwaysontop
...
Settimer, winmovemsgbox, 20
msgbox,262148,Reload -- Effectivity Macro V%Version_Number%, Are you sure that you want to reload the program?
IfMsgBox yes
{
Reload
}
...
Gui, 3:Show, x%amonx% y%amony%, Macro Timed Out -- Effectivity Macro V%Version_Number%
